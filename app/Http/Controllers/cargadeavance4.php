...
class cargadeavance4 extends Controller
{
...
public function updatecarga(Request $request, $id){
  ...
  $path = $request->file('file')->store('evidencia');
   ...
   return redirect("cargadeavance4")->with('actualizo', 'datos ');
  }else{
   $path =null;
   ...
   $avance->save();
  return redirect("cargadeavance4")->with('actualizo');
...
public function edit(cargadeavance4 $cargadeavance4,Request $request)
{
