...
<head>
    ...
    <meta charset="UTF-8">
    <title>Reporte 2° trimestre</title>
...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <table class="table">
              <tr>
                <th colspan="12"><h7>Reporte 2° trimestre</h7></th>
                  ...
                  @endphp
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number">
                        @php
         $suma=$pdf -> porcentaje_avance + $primer -> porcentaje_avance;//sumanos los valores, ahora solo fata mostrar dicho valor
       @endphp
       {{$suma}}%
                        </span>
