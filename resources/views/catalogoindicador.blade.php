...
<div class="container align-items-center">
  ...
  <div class="card">
      <div class="card-body">
  <div class="card">
    <H4 class="text-center"> Registrar Indicador del PMD al que se alinea:</H4><br><br><br>
    <form method="post" action="{{route('catalogoindicador')}}" id="formulario">
      @csrf
      <div class="card-body">
  <div class="card">
    <div class="form-row container">
  <div class="form-group col-md-6">
  <label for="nombre" class="text-dark etiquetas">Nombre del indicador:</label>
																		 ...
																		 <div class="table-responsive">
																				 <table class="table table-bordered table-striped table-hover">
																					 ...
																					 <i class="zmdi zmdi-delete zmdi-hc-lg" title="Eliminar Registro"></i>
																														 ...
																														 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editindicador{{ $id }}">
																										 ...
																										 function eliminar (id){
																											...
																											var url = '{{ route("deleteindicador", ":id") }}';
																										 url = url.replace(':id', id);
																										 window.location.href=url;
																												Swal.fire(
																													'Eliminado!',
																													'Su Indicador del PMD  ha sido eliminado.',
																													'success'
																												)
																											}
																											})
