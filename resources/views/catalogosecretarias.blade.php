...
<div class="container align-items-center">
  ...
  <div class="card">
      <div class="card-body">
  <div class="card">
    <H4 class="text-center"> Registrar Secretaria:</H4><br><br><br>
    <form method="post" action="{{route('catalogosecretarias')}}" id="formulario">
      @csrf
      <div class="card-body">
  <div class="card">
    <div class="form-row container">
  <div class="form-group col-md-6">
  <label for="nombre" class="text-dark etiquetas">Nombre de la Secretaria:</label>
										                             ...
										                             <th>Nombre de la Secretaria</th>
										                                 ...
										                                 <tr >
										                                     ...
										                                     <td >
										                                         ...
										                                         <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editChildresn{{ $id }}">
