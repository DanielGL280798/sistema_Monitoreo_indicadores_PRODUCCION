...
<div class="container align-items-center">
  ...
  <div class="card">
      <div class="card-body">
  <div class="card">
    <H4 class="text-center"> Registrar Estrategias:</H4><br><br><br>
    <form method="post" action="{{route('catalogoestrategias')}}" id="formulario">
      @csrf
      <div class="card-body">
  <div class="card">
																		 ...
																		 <div class="table-responsive">
																				 <table class="table table-bordered table-striped table-hover">
																					 ...
																					 <i class="zmdi zmdi-delete zmdi-hc-lg" title="Eliminar Registro"></i>
																														 ...
																														 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editestrategias{{ $id }}">
																										 ...
																										 function eliminar (id){
																											...
																											var url = '{{ route("deleteestrategias", ":id") }}';
																										 url = url.replace(':id', id);
																										 window.location.href=url;
																												Swal.fire(
																													'Eliminado!',
																													'Su secretaria  ha sido eliminado.',
																													'success'
																												)
																											}
																											})
