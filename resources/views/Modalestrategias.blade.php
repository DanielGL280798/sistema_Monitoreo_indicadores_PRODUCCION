<div class="modal fade" id="editestrategias{{ $id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ route('modificarestrategia', $id) }}">
          @method('PUT')
          @csrf
          @if(\Session::has('actualizo'))
            ...
            <div class="modal-body" id="cont_modal">
                ...
                <label for="nombre" class="text-dark etiquetas">Nombre de la Estrategia:</label>
