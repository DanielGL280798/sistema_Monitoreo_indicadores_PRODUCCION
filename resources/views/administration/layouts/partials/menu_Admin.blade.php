...
<div class="btn-group">
  ...
  <a class="dropdown-item {{ Route::is('permiso') ? 'active bg-success text-white' : '' }}" aria-current="page" href="{{route('catalogodirecciones')}}"><i class="fa fa-pencil"></i>  Registrar Direcciones</a>
...
<div class="btn-group">
  ...
  <div class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
  <a class="dropdown-item {{ Route::is('permiso') ? 'active bg-success text-white' : '' }}" aria-current="page" href="{{route('permiso')}}"><i class="fa fa-pencil"></i>  Permiso</a>
