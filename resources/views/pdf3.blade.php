...
<head>
    ...
    <meta charset="UTF-8">
    <title>Reporte 4° trimestre</title>
...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <table class="table">
              <tr>
                <th colspan="12"><h7>Reporte 4° trimestre</h7></th>
...
{{$tercer -> porcentaje_avance = $segundo -> porcentaje_avance +$tercer -> porcentaje_avance}}
                         <th colspan="2"
                         @if((int)$tercer -> porcentaje_avance >=0 && (int)$tercer -> porcentaje_avance <= 50)
                            style="background:red;"

                            @elseif ((int)$tercer -> porcentaje_avance >=51 && (int)$tercer -> porcentaje_avance <= 85)
                            style="background:yellow;"
                            @elseif ((int)$tercer -> porcentaje_avance >=86)
                            style="background:green;"
                            @elseif ((int)$tercer -> porcentaje_avance >= 100)
                            style="background:green;"
                  ...
                  @endphp
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number">
                        @php
         $suma=$pdf -> porcentaje_avance + $primer -> porcentaje_avance + $segundo->porcentaje_avance + $tercer->porcentaje_avance;//sumanos los valores, ahora solo fata mostrar dicho valor
       @endphp
       {{$suma}}%
                        </span>
