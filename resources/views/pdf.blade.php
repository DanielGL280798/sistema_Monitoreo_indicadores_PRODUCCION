...
<head>
    ...
    <meta charset="UTF-8">
    <title>Reporte 1° trimestre</title>
...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <table class="table">
              <tr>
                <th colspan="12"><h7>Reporte 1° trimestre</h7></th>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <tr>
                          ...
                          <th colspan="12"idth="50%" bgcolor="#ABB2B9"><h6>Representacion Grafica de Avance del Indicador: {{$pdf -> porcentaje_avance}}</h6></th>
                        </tr>
                  ...
                  <!-- Apply any bg-* class to to the info-box to color it -->
                    ...
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number">{{$pdf -> porcentaje_avance}}</span> --}}
                      <!-- The progress section is optional -->

                      <div class="progress">

                        <div class="progress-bar" role="progressbar" style="width:{{$pdf -> porcentaje_avance}}" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100">{{$pdf -> porcentaje_avance}}</div>
                        </div>
