...
<div class="container align-items-center">
  ...
  <div class="card">
      <div class="card-body">
  <div class="card">
      <H4 class="text-center">2º Trimestre Carga de Avance:</H4><br><br><br>
                                 ...
                                 <div class="table-responsive">
                                     <table id="example"  class="table table-bordered table-striped table-hover">
                                         <tr>
                                          ...
                                          <td><a href="{{route('Reporte1',$ma->id)}}" class="btn btn-outline-primary " target="_blank"><i class="zmdi zmdi-assignment-o mdc-text-green"> 2° trimestre </i>  </a>
                                                                          </ul>
