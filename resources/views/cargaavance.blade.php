...
<div class="container align-items-center">
  ...
  <H5 class="text-center">CARGA DE AVANCE PRIMER TRIMESTRE </H5>
  <form method="post" enctype="multipart/form-data"  action="{{route('cargaavance')}}" id="formulario">
  ...
  <H6 class="text-center"><center><strong>PLAN MUNICIPAL DE DESARROLLO DE TULANCINGO DE BRAVO 2020-2024 publicado:</strong></center></H6>
      ...
      <div class="form-row container">
        ...
        <div class="form-group col-md-6">
            <label for="metas" class="text-dark etiquetas">Meta actual: (que ingreso anteriormente)</label>
