...
<div class="container align-items-center">
  ...
  <div class="card">
      <div class="card-body">
  <div class="card">
    <H4 class="text-center"> Registrar Eje Estrategico:</H4><br><br><br>
    <form method="post" action="{{route('catalogoejes')}}" id="formulario">
      @csrf
      <div class="card-body">
  <div class="card">
    <div class="form-row container">
  <div class="form-group col-md-6">
  <label for="nombre" class="text-dark etiquetas">Nombre del Eje Estrategico:</label>
																	...
																	<div class="row">
																		...
																		<div class="table-responsive">
																				<table class="table table-bordered table-striped table-hover">
																						<tr>
																							<th>ID</th>
																								<th>Nombre de los ejes estrategicos</th>
																								 <th>Acción</th>
																						</tr>
																					...
																					<i class="zmdi zmdi-delete zmdi-hc-lg" title="Eliminar Registro"></i>
																														...
																														<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editeje{{ $id }}">
																										...
																										function eliminar (id){
																										 ...
																										 var url = '{{ route("deleteeje", ":id") }}';
																										url = url.replace(':id', id);
																										window.location.href=url;
																											 Swal.fire(
																												 'Eliminado!',
																												 'Su eje estrategicos  ha sido eliminado.',
																												 'success'
																											 )
																										 }
																										 })
