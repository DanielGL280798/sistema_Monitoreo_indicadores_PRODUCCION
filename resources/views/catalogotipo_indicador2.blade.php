...
<div class="container align-items-center">
  ...
  <div class="card">
      <div class="card-body">
  <div class="card">
    <H4 class="text-center"> Registrar Tipo de Nivel Indicador:</H4><br><br><br>
    <form method="post" action="{{route('catalogotipo_indicador2')}}" id="formulario">
      @csrf
      <div class="card-body">
  <div class="card">
    <div class="form-row container">
  <div class="form-group col-md-6">
  <label for="nombre" class="text-dark etiquetas">Nombre del Tipo De Nivel de Indicador:</label>
