<div class="modal fade" id="edittranse{{ $id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ route('modificartransversal', $id) }}">
          @method('PUT')
          @csrf
          @if(\Session::has('actualizo'))
            ...
            <div class="modal-body" id="cont_modal">
                ...
                <label for="nombre" class="text-dark etiquetas">Nombre de Transversal:</label>
