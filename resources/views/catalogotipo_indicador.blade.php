...
<div class="container align-items-center">
  <div class="card">
      <div class="card-body">
  <div class="card">
    <H4 class="text-center"> Registrar Tipo de Indicador:</H4><br><br><br>
    <form method="post" action="{{route('catalogotipo_indicador')}}" id="formulario">
      @csrf
      <div class="card-body">
  <div class="card">
    <div class="form-row container">
  <div class="form-group col-md-6">
  <label for="nombre" class="text-dark etiquetas">Nombre del Tipo De Indicador:</label>
 																		 ...
 																		 <div class="table-responsive">
 																				 <table class="table table-bordered table-striped table-hover">
 																					 ...
 																					 <i class="zmdi zmdi-delete zmdi-hc-lg" title="Eliminar Registro"></i>
 																														 ...
 																														 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edittipo{{ $id }}">
 																										 ...
 																										 function eliminar (id){
 																											...
 																											var url = '{{ route("deletetipoindicador", ":id") }}';
 																										 url = url.replace(':id', id);
 																										 window.location.href=url;
 																												Swal.fire(
 																													'Eliminado!',
 																													'Su indicador  ha sido eliminado.',
 																													'success'
 																												)
 																											}
 																											})
