<div class="modal fade"  id="moni{{ $mo->id}}"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-bs-target="#staticBackdrop">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #09ad19 !important;">
       ...
       <form method="POST" action="http://sistema_monitoreo_indicadores.domain/upda/"></form><form method="POST" action="{{ route('editmonitoreo', $mo ->id) }}">
           @method('PUT')
           @csrf
...
@enderror
  ...
  <div class="form-group col-md-12">
      <label for="descripcion_linea_base" class="text-dark etiquetas">Descripcion y año Base:</label>
  <input type="text" class="form-control bg-white p-3 border border-dark" id="descripcion_linea_base" name="descripcion_linea_base" value="{{$mo ->descripcion_linea_base }}">
      @error('descripcion_linea_base')
        <div class="alert text-center" style="background-color:#58D68D ; color:white" role="alert">{{ $message }}</div>
  @enderror
    </div>
  <div class="form-group col-md-12">
      <label for="metas" class="text-dark etiquetas">Meta (Año):</label>
  <input type="text" class="form-control bg-white p-3 border border-dark" id="metas" name="metas" value="{{ $mo -> metas }}">
      @error('metas')
        <div class="alert text-center" style="background-color:#58D68D ; color:white" role="alert">{{ $message }}</div>
  @enderror
    </div>
    <div class="form-group col-md-12">
      <label for="descripcion_meta" class="text-dark etiquetas">Descripcion y AñoMeta:</label>
  <input type="text" class="form-control bg-white p-3 border border-dark" id="descripcion_meta" name="descripcion_meta" value="{{ $mo ->descripcion_meta }}">
