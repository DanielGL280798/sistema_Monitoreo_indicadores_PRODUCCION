<div class="modal fade" id="edittipo{{ $id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ route('modificartipoindicador', $id) }}">
          @method('PUT')
          @csrf
